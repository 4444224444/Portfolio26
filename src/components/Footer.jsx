import './Footer.scss'
import resumeFile from '../assets/jhjpf.pdf' // assets 폴더 내 파일명에 맞춰 수정
    ...
    <footer className="footer">
      <div className="footer-inner">
        <div className="footer-col">
          ...
          <a href={resumeFile} download="정혜진_이력서.pdf" className="footer-text link">
            Download
          </a>
        </div>
        <div className="footer-col">
          ...
          <a href="mailto:jhj030424@gmail.com" className="footer-text link">
            jhj030424@gmail.com
          </a>
        </div>
        <div className="footer-col">
